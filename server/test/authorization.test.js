...
test('RRHH and prevention can register EPP deliveries',()=>{enforceStateScope('rrhh',{eppDeliveries:[]},{eppDeliveries:[{id:'e1'}]});enforceStateScope('prevencion',{eppMeasurements:{}},{eppMeasurements:{w1:{shoe:'42'}}});});
