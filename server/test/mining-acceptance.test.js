...
test('AC-27b exige vencimiento de arriendo para vehículo arrendado',()=>{const s=scenario();s.vehiculos=[{id:'v1',nombre:'Camioneta 1',propiedad:'arrendada',patente:'AB-CD-12',minaIds:['m1']}];rejects(s,'MISSING_RENTAL_EXPIRY');s.vehiculos[0].arriendoVence='2026-12-31';assert.doesNotThrow(()=>validateTenantState(s));});
