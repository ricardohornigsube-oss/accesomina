...
await withTenant(tenantId,client=>client.query(`UPDATE app_users SET password_hash=$1,password_salt=$2,active=true,must_change_password=true,updated_at=now()
